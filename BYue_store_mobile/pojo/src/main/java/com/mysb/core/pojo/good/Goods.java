...
public class Goods implements Serializable {
    ...
    public String getIsYouLike() {
        return isYouLike;
    }

    public void setIsYouLike(String isYouLike) {
        this.isYouLike = isYouLike == null ? null : isYouLike.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", isYouLike=").append(isYouLike);
        sb.append(", isFlashSale=").append(isFlashSale);
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getIsYouLike() == null ? other.getIsYouLike() == null : this.getIsYouLike().equals(other.getIsYouLike()))
            && (this.getIsFlashSale() == null ? other.getIsFlashSale() == null : this.getIsFlashSale().equals(other.getIsFlashSale()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getIsYouLike() == null) ? 0 : getIsYouLike().hashCode());
        result = prime * result + ((getIsFlashSale() == null) ? 0 : getIsFlashSale().hashCode());
        return result;
    }
}